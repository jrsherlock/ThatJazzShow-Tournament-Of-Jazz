...
const REGION_DESCRIPTIONS: Record<string, string> = {
  state_superpowers:
    'The most powerful cyber forces on the planet. Intelligence agencies and military units with virtually unlimited resources, deploying implants that persist for years.',
  infrastructure_hunters:
    'The groups that go after what keeps society running. Power grids, telecom networks, water systems — nothing is off-limits for these critical infrastructure attackers.',
  cybercriminal_cartels:
    'Follow the money. Ransomware-as-a-Service empires, billion-dollar extortion rings, and criminal syndicates operating as shadow enterprises.',
  shadow_market:
    'The mercenaries and wildcards. Private surveillance vendors, state-linked contractors, and decentralized collectives selling zero-days to the highest bidder.',
};
...
async function getTournamentData() {
  ...
  return { tournament, submissionCount, actorCount };
}
...
function ExploreIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <circle cx="20" cy="20" r="18" stroke="#DC2626" strokeWidth="1.5" fill="none" />
      <path d="M15 13h10M15 20h10M15 27h7" stroke="#DC2626" strokeWidth="1.5" strokeLinecap="round" />
      <circle cx="11" cy="13" r="1.5" fill="#DC2626" />
      <circle cx="11" cy="20" r="1.5" fill="#DC2626" />
      <circle cx="11" cy="27" r="1.5" fill="#DC2626" />
    </svg>
  );
}
...
function PicksIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <circle cx="20" cy="20" r="18" stroke="#DC2626" strokeWidth="1.5" fill="none" />
      <path d="M13 21l4 4 10-10" stroke="#DC2626" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function CompeteIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <circle cx="20" cy="20" r="18" stroke="#DC2626" strokeWidth="1.5" fill="none" />
      <path d="M14 26V18l6-5 6 5v8" stroke="#DC2626" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M18 26v-5h4v5" stroke="#DC2626" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M20 13v-2M24 14l1.5-1.5M16 14l-1.5-1.5" stroke="#DC2626" strokeWidth="1.2" strokeLinecap="round" />
    </svg>
  );
}
...
export default async function Home() {
  const { tournament, submissionCount, actorCount } = await getTournamentData();
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative flex flex-col items-center justify-center text-center overflow-hidden min-h-[90vh] sm:min-h-[85vh]">
        {/* Hero image — full-bleed with cinematic reveal */}
        <div className="absolute inset-0 hero-image-reveal overflow-hidden">
          <img
            src="/images/bracket-hacker.png"
            alt="Tournament of Threats cybersecurity bracket"
          ...
          />
          {/* Red tint overlay — ties image into site palette */}
          <div
            className="absolute inset-0 mix-blend-overlay opacity-25"
            style={{ background: 'linear-gradient(135deg, #B91C1C, transparent 60%)' }}
          />
          {/* Vignette */}
          <div
            className="absolute inset-0"
        ...
        <div className="relative z-10 px-6 pt-32 pb-24 sm:pt-40 sm:pb-32 flex flex-col items-center">
          ...
          <h1
            ...
            style={{ animationDelay: '1.1s', color: '#EF4444' }}
          >
            of Threats
          </h1>
          ...
          >
            32 of the world&apos;s most dangerous threat actors. One champion. Rank the threats.
          </p>
          ...
          {isOpen ? (
            ...
            >
              <Link
                href="/play"
                className="inline-block bg-white/95 text-[#B91C1C] font-display text-lg px-10 py-4 rounded-sm hover:bg-white transition-colors tracking-wide uppercase shadow-lg shadow-black/30"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="accent-glow bg-surface-hover border border-accent/20 rounded-sm p-8 flex flex-col items-center text-center">
              ...
              <p className="text-muted text-sm leading-relaxed">
                Review threat intelligence briefings, known operations, and attribution data for each matchup.
              </p>
            </div>
            ...
            <div className="accent-glow bg-surface-hover border border-accent/20 rounded-sm p-8 flex flex-col items-center text-center">
              ...
              <p className="text-muted text-sm leading-relaxed">
                Choose the more dangerous threat actor in each of 31 matchups. Add your analysis.
              </p>
            </div>
            ...
            <div className="accent-glow bg-surface-hover border border-accent/20 rounded-sm p-8 flex flex-col items-center text-center">
              ...
              <p className="text-muted text-sm leading-relaxed">
                See how your threat assessments compare as results are revealed.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="mt-auto px-6 py-12 text-center">
        ...
        <p className="text-muted text-xs mt-4">
          &copy; {new Date().getFullYear()} Tournament of Threats
        </p>
      </footer>
    </div>
  );
